...
const kPrimaryColor = Color(0xFF146AC0);
const kPrimaryColor50 = Color(0xFF84AFDA);

const kSecondaryColor = Color(0xFF359CE6);
const kSecondaryColor2 = Color(0xFF0088FF);
const kSecondaryGreenColor = Color(0xFF3CCF17);
const kSecondaryRedColor = Color(0xFFCF1B2B);
...
const kFontText8 = Color(0xFF4F4F499);
...
const kContainerBackgroundGradeintColor = LinearGradient(
  colors: [Color(0xFFF6CACB), Color(0xFFF4F4F4)], // Light orange to red
...
const kContainerBackgroundGradeintColor2 = LinearGradient(
  colors: [Color(0xFFE4A12C), Color(0xFFFFD14C)], // Light orange to red
  begin: Alignment.centerLeft,
  end: Alignment.centerRight,
);

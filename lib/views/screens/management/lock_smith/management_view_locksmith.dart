...
class ManagmentViewLockSmithScreen extends StatefulWidget {
  const ManagmentViewLockSmithScreen({super.key});

  @override
  State<ManagmentViewLockSmithScreen> createState() =>
      _ManagmentViewLockSmithScreenState();
}

class _ManagmentViewLockSmithScreenState
    extends State<ManagmentViewLockSmithScreen>

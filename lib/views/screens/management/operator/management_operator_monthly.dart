...
class ManagmentOperatorMonthlyScreen extends StatefulWidget {
  const ManagmentOperatorMonthlyScreen({super.key});

  @override
  State<ManagmentOperatorMonthlyScreen> createState() =>
      _ManagmentOperatorMonthlyScreenState();
}

class _ManagmentOperatorMonthlyScreenState extends State<ManagmentOperatorMonthlyScreen>
      ...
      body: Column(
        ...
        children: [
          ...
          CustomAppBar(
            ...
            showUserName: true,
            searchText: "Search 0perators...",
            userName: "Operators Monthly",

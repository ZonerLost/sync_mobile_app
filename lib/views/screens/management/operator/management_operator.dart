...
class ManagmentOperatorScreen extends StatefulWidget {
  const ManagmentOperatorScreen({super.key});

  @override
  State<ManagmentOperatorScreen> createState() =>
      _ManagmentOperatorScreenState();
}

class _ManagmentOperatorScreenState extends State<ManagmentOperatorScreen>

...
class ManagmentOperatorWeeklyScreen extends StatefulWidget {
  const ManagmentOperatorWeeklyScreen({super.key});

  @override
  State<ManagmentOperatorWeeklyScreen> createState() =>
      _ManagmentOperatorWeeklyScreenState();
}

class _ManagmentOperatorWeeklyScreenState extends State<ManagmentOperatorWeeklyScreen>
      ...
      body: Column(
        ...
        children: [
          ...
          CustomAppBar(
            ...
            showUserName: true,
            searchText: "Search operators...",
            userName: "Operators Weekly",

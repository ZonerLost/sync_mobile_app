...
class ManagmentAddOperatorScreen extends StatefulWidget {
  const ManagmentAddOperatorScreen({super.key});

  @override
  State<ManagmentAddOperatorScreen> createState() =>
      _ManagmentAddOperatorScreenState();
}

class _ManagmentAddOperatorScreenState extends State<ManagmentAddOperatorScreen>
      ...
      body: Column(
        ...
        children: [
          ...
          CustomAppBar(
            ...
            onNotificationTap: () {
              showAddOperatorBottomSheet(context);
            },
          ),

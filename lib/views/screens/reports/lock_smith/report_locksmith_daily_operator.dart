...
class ReportLockSmithDailyOperatorScreen extends StatefulWidget {
  const ReportLockSmithDailyOperatorScreen({super.key});

  @override
  State<ReportLockSmithDailyOperatorScreen> createState() =>
      _ReportLockSmithDailyOperatorScreenState();
}

class _ReportLockSmithDailyOperatorScreenState
    extends State<ReportLockSmithDailyOperatorScreen> {

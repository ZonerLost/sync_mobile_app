...
class ReportLockSmithMonthlyOperatorScreen extends StatefulWidget {
  const ReportLockSmithMonthlyOperatorScreen({super.key});

  @override
  State<ReportLockSmithMonthlyOperatorScreen> createState() =>
      _ReportLockSmithMonthlyOperatorScreenState();
}

class _ReportLockSmithMonthlyOperatorScreenState
    extends State<ReportLockSmithMonthlyOperatorScreen> {

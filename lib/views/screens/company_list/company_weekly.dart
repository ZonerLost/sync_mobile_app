...
class CompanyWeeklyScreen extends StatefulWidget {
  const CompanyWeeklyScreen({super.key});

  @override
  State<CompanyWeeklyScreen> createState() => _CompanyWeeklyScreenState();
}

class _CompanyWeeklyScreenState extends State<CompanyWeeklyScreen>
